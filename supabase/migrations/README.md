...
| `005_profiles_whatsapp_fields.sql` | Fase 11 | Campos WhatsApp en perfiles |
| `006_fix_knockout_points_composite.sql` | Fix | Puntaje compuesto llaves (3+2) y recálculo existente |
